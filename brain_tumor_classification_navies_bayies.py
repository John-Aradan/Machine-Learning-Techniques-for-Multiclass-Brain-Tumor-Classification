# -*- coding: utf-8 -*-
"""Brain-Tumor-Classification-Navies_Bayies.ipynb

Automatically generated by Colaboratory.

Original file is located at
    https://colab.research.google.com/drive/1QLldzQ4Gb0lAsihHWDYmA4d74uqs5AbZ
"""
...
pred = nb.predict(xtest) # sv_pred -> prediction for each image(xtest) value
...
print(xtest.shape,pred.shape,ytest.shape)

xtest.shape[0] == pred.shape[0] == ytest.shape[0]
...
test_path = "/content/drive/MyDrive/Brain_Tumor_Classification/brain-tumor-detection-master/brain_tumor/Testing/"   # path to test set folder
