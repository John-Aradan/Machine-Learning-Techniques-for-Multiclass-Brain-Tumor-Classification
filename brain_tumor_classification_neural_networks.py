# -*- coding: utf-8 -*-
"""Brain-Tumor-Classification-Neural_Networks.ipynb

Automatically generated by Colaboratory.

Original file is located at
    https://colab.research.google.com/drive/10lawWvE5YMN22nYge0VlaoWBR-AArlZ3
"""
...
nn = MLPClassifier(hidden_layer_sizes=(100,100,100), max_iter=500, random_state=0) # 3 layers of 100 nodes itterating 500 times
nn.fit(xtrain, ytrain)

"""### Prediction"""

pred = nn.predict(xtest) # sv_pred -> prediction for each image(xtest) value
